...
Positions=initialization_IGWO(N,dim,ub,lb);
Positions = boundConstraint_IGWO(Positions, Positions, lu);
...
while iter < Max_iter
    ...
    for i=1:size(Positions,1)
        ...
        X_GWO(i,:) = boundConstraint_IGWO(X_GWO(i,:), Positions(i,:), lu);
    ...
    for t=1:N
        ...
        X_DLH(t,:) = boundConstraint_IGWO(X_DLH(t,:), Positions(t,:), lu);
